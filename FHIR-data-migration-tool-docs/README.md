...
> [!WARNING]
> If your Azure API for FHIR (Gen 1) instance contains more than 2 TB of data, open an [Azure support request](https://learn.microsoft.com/azure/azure-portal/supportability/how-to-create-azure-support-request) **before** starting your migration. In the support ticket, include your Gen 1 (Azure API for FHIR) instance name and your Gen 2 (Azure Health Data Services FHIR service) instance name so the team can assist with your migration planning.
